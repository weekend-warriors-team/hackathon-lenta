    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales_units', models.DecimalField(decimal_places=3, max_digits=12, verbose_name='Число проданных товаров без промо')),
                ('sales_units_promo', models.DecimalField(decimal_places=3, max_digits=12, verbose_name='Число проданных товаров с промо')),
